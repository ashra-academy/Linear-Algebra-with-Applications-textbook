...
\vspace*{-2em}
\centering
\input{8-orthogonality/figures/8-an-application-to-quadratic-forms/rotation-graph}
...
\centering
\input{8-orthogonality/figures/8-an-application-to-quadratic-forms/example8.8.3}
