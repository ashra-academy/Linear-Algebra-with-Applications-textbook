...
\vspace{-2em}
\centering
\input{5-vector-space-rn/figures/3-orthogonality/corollary5.3.1}
...
\begin{wrapfigure}[3]{l}{5cm} 
  \vspace*{-2em}
	\centering
	\input{5-vector-space-rn/figures/3-orthogonality/definition5.7}
...
\vspace*{-2em}
\centering
\input{5-vector-space-rn/figures/3-orthogonality/example5.3.6}
